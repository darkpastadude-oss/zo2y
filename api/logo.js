...
const MANUAL_LOGO_OVERRIDES = new Map([
  ...
  ['title:ben & jerry\'s', 'Ben_%26_Jerry%27s.svg'],
  ['title:ben and jerry\'s', 'Ben_%26_Jerry%27s.svg'],
  ['domain:benjerry.com', 'Ben_%26_Jerry%27s.svg'],
  ['title:blaze pizza', 'Blazepizza.svg'],
  ['domain:blazepizza.com', 'Blazepizza.svg'],
  ['title:bob evans', 'Bob_Evans_logo.svg'],
  ['domain:bobevans.com', 'Bob_Evans_logo.svg'],
  ['title:buc-ee\'s', 'Buc-ee\'s_logo.svg'],
  ['title:bucees', 'Buc-ee\'s_logo.svg'],
  ['domain:bucees.com', 'Buc-ee\'s_logo.svg'],
  ['title:cargill', 'Cargill_logo.svg'],
  ['domain:cargill.com', 'Cargill_logo.svg'],
  ['title:carvel', 'Carvel_logo.svg'],
  ['domain:carvel.com', 'Carvel_logo.svg'],
  ['title:casey\'s general store', 'Casey%27s_logo.svg'],
  ['title:casey\'s', 'Casey%27s_logo.svg'],
  ['domain:caseys.com', 'Casey%27s_logo.svg'],
  ['title:chuck e. cheese', 'Chuck_E._Cheese_logo.svg'],
  ['title:chuck e cheese', 'Chuck_E._Cheese_logo.svg'],
  ['domain:chuckecheese.com', 'Chuck_E._Cheese_logo.svg'],
  ...
  ['title:godiva', 'Godiva_logo.svg'],
  ['domain:godiva.com', 'Godiva_logo.svg'],
  ...
  ['title:hungry howie\'s', 'Hungry_Howie\'s_logo.svg'],
  ['title:hungry howies', 'Hungry_Howie\'s_logo.svg'],
  ['domain:hungryhowies.com', 'Hungry_Howie\'s_logo.svg'],
  ...
  ['title:lindt', 'Lindt_logo.svg'],
  ['domain:lindt.com', 'Lindt_logo.svg'],
  ['title:lou malnati\'s', 'Lou_Malnati\'s_logo.svg'],
  ['title:lou malnatis', 'Lou_Malnati\'s_logo.svg'],
  ['domain:loumalnatis.com', 'Lou_Malnati\'s_logo.svg'],
  ...
  ['title:mellow mushroom', 'Mellow_Mushroom_logo.svg'],
  ['domain:mellowmushroom.com', 'Mellow_Mushroom_logo.svg'],
  ...
  ['title:round table pizza', 'Round_Table_Pizza_logo.svg'],
  ['domain:roundtablepizza.com', 'Round_Table_Pizza_logo.svg'],
  ['title:sheetz', 'Sheetz_logo.svg'],
  ['domain:sheetz.com', 'Sheetz_logo.svg'],
  ['title:snooze a.m. eatery', 'Snooze_A.M._Eatery_logo.svg'],
  ['title:snooze', 'Snooze_A.M._Eatery_logo.svg'],
  ['domain:snoooze.com', 'Snooze_A.M._Eatery_logo.svg'],
  ['title:tgi friday\'s', 'TGI_Fridays_logo.svg'],
  ['title:tgi fridays', 'TGI_Fridays_logo.svg'],
  ['domain:tgifridays.com', 'TGI_Fridays_logo.svg'],
  ['title:tljus', 'TLJUS_logo.svg'],
  ['domain:tljus.com', 'TLJUS_logo.svg'],
  ...
  ['title:allsaints', 'AllSaints_logo.svg'],
  ['domain:allsaints.com', 'AllSaints_logo.svg'],
  ['title:amiri', 'Amiri_logo.svg'],
  ['domain:amiri.com', 'Amiri_logo.svg'],
  ['title:audemars piguet', 'Audemars_Piguet_logo.svg'],
  ['domain:audemarspiguet.com', 'Audemars_Piguet_logo.svg'],
  ['title:breitling', 'Breitling_logo.svg'],
  ['domain:breitling.com', 'Breitling_logo.svg'],
  ...
  ['title:christian louboutin', 'Christian_Louboutin_logo.svg'],
  ['domain:christianlouboutin.com', 'Christian_Louboutin_logo.svg'],
  ['title:chrome hearts', 'Chrome_Hearts_logo.svg'],
  ['domain:chromehearts.com', 'Chrome_Hearts_logo.svg'],
  ['title:essentials', 'Essentials_(brand)_logo.svg'],
  ['title:everlane', 'Everlane_logo.svg'],
  ['domain:everlane.com', 'Everlane_logo.svg'],
  ['title:ganni', 'GANNI_logo.svg'],
  ['domain:gannicyclopedia.com', 'GANNI_logo.svg'],
  ['title:gymshark', 'Gymshark_logo.svg'],
  ['domain:gymshark.com', 'Gymshark_logo.svg'],
  ['title:hoka one one', 'Hoka_logo.svg'],
  ['title:hoka', 'Hoka_logo.svg'],
  ['domain:hoka.com', 'Hoka_logo.svg'],
  ['title:jacquemus', 'Jacquemus_logo.svg'],
  ['domain:jacquemus.com', 'Jacquemus_logo.svg'],
  ...
  ['title:longines', 'Longines_logo.svg'],
  ['domain:longines.com', 'Longines_logo.svg'],
  ['title:maison margiela', 'Maison_Margiela_logo.svg'],
  ['domain:maisonmargiela.com', 'Maison_Margiela_logo.svg'],
  ['title:manolo blahnik', 'Manolo_Blahnik_logo.svg'],
  ['domain:manoloblahnik.com', 'Manolo_Blahnik_logo.svg'],
  ...
  ['title:patek philippe', 'Patek_Philippe_logo.svg'],
  ['domain:patek.com', 'Patek_Philippe_logo.svg'],
  ['title:ray-ban', 'Ray-Ban_logo.svg'],
  ['title:rayban', 'Ray-Ban_logo.svg'],
  ['domain:ray-ban.com', 'Ray-Ban_logo.svg'],
  ['title:reformation', 'Reformation_logo.svg'],
  ['domain:thereformation.com', 'Reformation_logo.svg'],
  ['title:rick owens', 'Rick_Owens_logo.svg'],
  ['domain:rickowens.com', 'Rick_Owens_logo.svg'],
  ...
  ['title:stella mccartney', 'Stella_McCartney_logo.svg'],
  ['domain:stellamccartney.com', 'Stella_McCartney_logo.svg'],
