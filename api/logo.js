...
const MANUAL_LOGO_OVERRIDES = new Map([
  ...
  ['title:mcdonald\'s', 'McDonald\'s logo.svg'],
  ['title:mcdonalds', 'McDonald\'s logo.svg'],
  ['domain:mcdonalds.com', 'McDonald\'s logo.svg'],
  ['title:kfc', 'KFC_logo.svg'],
  ['domain:kfc.com', 'KFC_logo.svg'],
  ['title:starbucks', 'Starbucks_Coffee_logo.svg'],
  ['domain:starbucks.com', 'Starbucks_Coffee_logo.svg'],
  ['title:taco bell', 'Taco_Bell_logo_(2016).svg'],
  ['domain:tacobell.com', 'Taco_Bell_logo_(2016).svg'],
  ['title:burger king', 'Burger_King_logo_(2017).svg'],
  ['domain:burgerking.com', 'Burger_King_logo_(2017).svg'],
  ['title:domino\'s', 'Domino\'s Pizza logo.svg'],
  ['title:dominos', 'Domino\'s Pizza logo.svg'],
  ['domain:dominos.com', 'Domino\'s Pizza logo.svg'],
  ['title:subway', 'Subway_(restaurant)_logo.svg'],
  ['domain:subway.com', 'Subway_(restaurant)_logo.svg'],
  ['title:popeyes', 'Popeyes_logo.svg'],
  ['domain:popeyes.com', 'Popeyes_logo.svg'],
  ['title:wendy\'s', 'Wendy\'s_logo.svg'],
  ['title:wendys', 'Wendy\'s_logo.svg'],
  ['domain:wendys.com', 'Wendy\'s_logo.svg'],
  ['title:pizza hut', 'Pizza_Hut_logo.svg'],
  ['domain:pizzahut.com', 'Pizza_Hut_logo.svg'],
  ['title:shake shack', 'Shake_Shack_logo.svg'],
  ['domain:shakeshack.com', 'Shake_Shack_logo.svg'],
  ['title:chipotle', 'Chipotle_Mexican_Grill_logo.svg'],
  ['domain:chipotle.com', 'Chipotle_Mexican_Grill_logo.svg'],
  ...
  ['title:papa john\'s', 'Papa_John\'s_logo.svg'],
  ['title:papa johns', 'Papa_John\'s_logo.svg'],
  ['domain:papajohns.com', 'Papa_John\'s_logo.svg'],
  ['title:peet\'s coffee', 'Peet\'s_Coffee_logo.svg'],
  ['title:peets coffee', 'Peet\'s_Coffee_logo.svg'],
  ['domain:peets.com', 'Peet\'s_Coffee_logo.svg'],
  ['title:great american cookies', 'Great_American_Cookies_logo.svg'],
  ['domain:greatamericancookies.com', 'Great_American_Cookies_logo.svg'],
  ['title:f\'real', 'F\'real_logo.svg'],
  ['title:freal', 'F\'real_logo.svg'],
  ['domain:freal.com', 'F\'real_logo.svg'],
  ['title:umami burger', 'Umami_Burger_logo.svg'],
  ['domain:umamiburger.com', 'Umami_Burger_logo.svg'],
  ['title:teriyaki madness', 'Teriyaki_Madness_logo.svg'],
  ['domain:teriyakimadness.com', 'Teriyaki_Madness_logo.svg'],
  ['title:torchy\'s tacos', 'Torchy\'s_Tacos_logo.svg'],
  ['title:torchys tacos', 'Torchy\'s_Tacos_logo.svg'],
  ['domain:torchystacos.com', 'Torchy\'s_Tacos_logo.svg'],
  ['title:chili\'s', 'Chili\'s_logo.svg'],
  ['title:chilis', 'Chili\'s_logo.svg'],
  ['domain:chilis.com', 'Chili\'s_logo.svg'],
  ['title:the cheesecake factory', 'The_Cheesecake_Factory_logo.svg'],
  ['domain:thecheesecakefactory.com', 'The_Cheesecake_Factory_logo.svg'],
  ['title:red robin', 'Red_Robin_logo.svg'],
  ['domain:redrobin.com', 'Red_Robin_logo.svg'],
  ['title:zippy\'s', 'Zippy\'s_logo.svg'],
  ['title:zippys', 'Zippy\'s_logo.svg'],
  ['domain:zippys.com', 'Zippy\'s_logo.svg'],
  ['title:wagamama', 'Wagamama_logo.svg'],
  ['domain:wagamama.com', 'Wagamama_logo.svg'],
  ['title:dave & buster\'s', 'Dave_%26_Buster\'s_logo.svg'],
  ['title:dave and buster\'s', 'Dave_%26_Buster\'s_logo.svg'],
  ['domain:daveandbusters.com', 'Dave_%26_Buster\'s_logo.svg'],
  ['title:the capital grille', 'The_Capital_Grille_logo.svg'],
  ['domain:thecapitalgrille.com', 'The_Capital_Grille_logo.svg'],
  ...
  ['title:mammut', 'Mammut_logo.svg'],
  ['domain:mammut.com', 'Mammut_logo.svg'],
  ['title:marmot', 'Marmot_logo.svg'],
  ['domain:marmot.com', 'Marmot_logo.svg'],
  ['title:rothy', 'Rothy\'s_logo.svg'],
  ['title:rothy\'s', 'Rothy\'s_logo.svg'],
  ['domain:rothys.com', 'Rothy\'s_logo.svg']
]);
