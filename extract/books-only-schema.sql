-- Books-only schema (no movie tables touched)
...
drop trigger if exists trg_book_lists_updated_at on public.book_lists;
create trigger trg_book_lists_updated_at
