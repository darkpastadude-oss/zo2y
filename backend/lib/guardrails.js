...
export function applySecurityHeaders(_req, res, next) {
  ...
  const cspDirectives = [
    ...
    "connect-src https://archive.org https://*.archive.org 'self' https://*.dzcdn.net https://cdn-images.dzcdn.net https://api.rawg.io https://gfkhjbztayjyojsgdpgk.supabase.co https://api.supabase.com https://image.tmdb.org https://covers.openlibrary.org https://books.googleusercontent.com https://i.scdn.co https://images.igdb.com https://flagcdn.com https://commons.wikimedia.org https://www.thesportsdb.com https://media.rawg.io https://is1-ssl.mzstatic.com https://itunes.apple.com https://images.unsplash.com https://images.pexels.com https://en.wikipedia.org https://*.wikidata.org https://wikimedia.org",
    "frame-src 'self'",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
