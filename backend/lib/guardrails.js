...
export function applySecurityHeaders(_req, res, next) {
  ...
  const cspDirectives = [
    ...
    "connect-src 'self' https://gfkhjbztayjyojsgdpgk.supabase.co https://api.supabase.com https://image.tmdb.org https://covers.openlibrary.org https://books.googleusercontent.com https://i.scdn.co https://images.igdb.com https://flagcdn.com https://commons.wikimedia.org https://restcountries.com https://www.thesportsdb.com https://media.rawg.io https://is1-ssl.mzstatic.com https://itunes.apple.com",
    "frame-src 'self'",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
