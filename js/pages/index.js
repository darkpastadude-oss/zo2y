    ...
    const HOME_SPORTS_COVERS_URL = '/assets/data/sports_covers.json?v=20260713i';
...
const HOME_DEFERRED_IMAGE_ROOT_MARGIN = '420px 0px';
    ...
    function ensureHomeGamesShared() {
      ...
      homeGamesSharedScriptPromise = new Promise((resolve, reject) => {
        ...
        script.src = 'js/pages/games-shared.js?v=20260806a';
        script.defer = true;
    ...
    async function loadTravel(signal) {
      ...
      function getHomeCuratedTeams() {
        const teams = [
          ...
          { name: 'Pittsburgh Steelers', sport: 'Football', league: 'NHL', local: '/assets/logos/nfl/pittsburghsteelers.png' },
