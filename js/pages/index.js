...
const HOME_DEFERRED_IMAGE_ROOT_MARGIN = '420px 0px';
    ...
    function mapHomeBrandItem(row, type, fallbackIndex = 0) {
      ...
      const logo = String(row?.logo || row?.logo_url || '').trim();
      const subtitle = league || sport || 'Sports';
    ...
    async function refreshHomeNewReleases(feedMap = homeFeedState, options = {}) {
      ...
      const requestTask = (async () => {
        ...
        if (safeLiveItems.length) {
          ...
          homeNewReleasesState = fallbackItems;
          homeNewReleasesLastFetchAt = Date.now();
          renderOrDeferHomeRail('newReleasesRail', homeNewReleasesState, railOptions);
    ...
    async function saveToListFromHome(payload) {
      ...
      try {
        if (mediaType === 'sports') {
          let teamId = String(payload.itemId || '').trim();
          if (!teamId) {
    ...
    function getHomeRailFallbackItems(_channelKey) {
      ...
      if (key === 'sports') {
        return HOME_SPORTS_FALLBACKS.slice(0, targetCount).map((row, index) => ({
          ...mapHomeSportsItem(row, index),
    ...
    async function loadMusic(signal) {
      ...
      const fallback = [
        { id: "1786885073", name: "Die With A Smile", artists: ["Lady Gaga", "Bruno Mars"], image: "https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/18/93/6a/18936a7f-238a-383e-960c-d76be7187e90/24UMGIM62253.rgb.jpg/600x600bb.jpg" },
        { id: "1776815963", name: "A Bar Song (Tipsy)", artists: ["Shaboozey"], image: "https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/4e/62/00/4e6200e0-4a7b-cd5e-d1b7-9a36109c7c48/24UMGIM36640.rgb.jpg/600x600bb.jpg" },
        { id: "1746018235", name: "I Had Some Help", artists: ["Post Malone", "Morgan Wallen"], image: "https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/9d/35/98/9d35982a-6c9b-423d-b757-146e282d5863/24UMGIM02785.rgb.jpg/600x600bb.jpg" },
        { id: "1738258033", name: "Lose Control", artists: ["Teddy Swims"], image: "https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/2e/90/03/2e90035d-d588-ddf0-2e05-f83f0e8744af/23UM1IM45862.rgb.jpg/600x600bb.jpg" },
        { id: "1731742554", name: "Taste", artists: ["Sabrina Carpenter"], image: "https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/38/82/06/38820667-e2c5-35b6-9004-43ab4b61f6fa/24UMGIM39301.rgb.jpg/600x600bb.jpg" },
        { id: "1727299764", name: "Espresso", artists: ["Sabrina Carpenter"], image: "https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/8d/38/54/8d38546f-e164-e34b-511b-a4b500bf4213/24UMGIM62688.rgb.jpg/600x600bb.jpg" },
        { id: "1696313419", name: "Beautiful Things", artists: ["Benson Boone"], image: "https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/65/82/90/65829058-f42c-3058-81e0-83a9c50616b0/24UMGIM54155.rgb.jpg/600x600bb.jpg" },
        { id: "1741021439", name: "BIRDS OF A FEATHER", artists: ["Billie Eilish"], image: "https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/50/84/a4/5084a45b-9029-43ec-b7e5-f8a8f2e1330e/24UMGIM63520.rgb.jpg/600x600bb.jpg" }
      ];
      const fallbackItems = fallback.map(function(t) {
        const arts = String(t.artists || []).filter(Boolean).join(', ');
        const img = upgradeArt(t.image || '');
        return {
          mediaType: 'music', itemId: String(t.id || ''),
          title: String(t.name || 'Track').trim(),
          subtitle: arts, extra: 'Song',
          image: img, backgroundImage: img, spotlightImage: img,
          spotlightMediaFit: 'contain', spotlightMediaShape: 'poster',
          previewUrl: '', href: 'music.html'
        };
      }).slice(0, targetCount);
      writeHomeItemsCache(HOME_MUSIC_ITEMS_CACHE_KEY, fallbackItems);
    ...
    async function loadTravel(signal) {
      ...
      function getHomeCuratedTeams() {
        const teams = [
          { name: 'PSG', sport: 'Soccer', league: 'Ligue 1', local: '/assets/logos/football/french-ligue-1/psg.png' },
          ...
          { name: 'Oklahoma City Thunder', sport: 'Basketball', league: 'NBA West Finals', local: '/assets/logos/nba/oklahomacitythunder.png' },
          { name: 'San Antonio Spurs', sport: 'Basketball', league: 'NBA West Finals', local: '/assets/logos/nba/sanantoniospurs.png' },
          ...
          { name: 'Barcelona', sport: 'Soccer', league: 'La Liga', local: '/assets/logos/football/spanish-la-liga/barcelona.png' },
          { name: 'Atletico Madrid', sport: 'Soccer', league: 'La Liga', local: '/assets/logos/football/spanish-la-liga/atleticomadrid.png' },
          { name: 'Sevilla', sport: 'Soccer', league: 'La Liga', local: '/assets/logos/football/spanish-la-liga/sevilla.png' },
          { name: 'Villarreal', sport: 'Soccer', league: 'La Liga', local: '/assets/logos/football/spanish-la-liga/villarreal.png' },
          { name: 'Real Sociedad', sport: 'Soccer', league: 'La Liga', local: '/assets/logos/football/spanish-la-liga/realsociedad.png' },
          { name: 'Athletic Bilbao', sport: 'Soccer', league: 'La Liga', local: '/assets/logos/football/spanish-la-liga/athleticbilbao.png' },
          ...
          { name: 'Chelsea', sport: 'Soccer', league: 'Premier League', local: '/assets/logos/football/english-premier-league/chelsea.png' },
          { name: 'Manchester United', sport: 'Soccer', league: 'Premier League', local: '/assets/logos/football/english-premier-league/manchesterunited.png' },
          { name: 'Tottenham Hotspur', sport: 'Soccer', league: 'Premier League', local: '/assets/logos/football/english-premier-league/tottenhamhotspur.png' },
          { name: 'Newcastle United', sport: 'Soccer', league: 'Premier League', local: '/assets/logos/football/english-premier-league/newcastleunited.png' },
          { name: 'Aston Villa', sport: 'Soccer', league: 'Premier League', local: '/assets/logos/football/english-premier-league/astonvilla.png' },
          { name: 'Brighton', sport: 'Soccer', league: 'Premier League', local: '/assets/logos/football/english-premier-league/brightonandhovealbion.png' },
          { name: 'West Ham United', sport: 'Soccer', league: 'Premier League', local: '/assets/logos/football/english-premier-league/westhamunited.png' },
          { name: 'Everton', sport: 'Soccer', league: 'Premier League', local: '/assets/logos/football/english-premier-league/everton.png' },
          { name: 'Inter Milan', sport: 'Soccer', league: 'Serie A', local: '/assets/logos/football/italian-serie-a/intermilan.png' },
          { name: 'AC Milan', sport: 'Soccer', league: 'Serie A', local: '/assets/logos/football/italian-serie-a/acmilan.png' },
          { name: 'Juventus', sport: 'Soccer', league: 'Serie A', local: '/assets/logos/football/italian-serie-a/juventus.png' },
          { name: 'Napoli', sport: 'Soccer', league: 'Serie A', local: '/assets/logos/football/italian-serie-a/napoli.png' },
          { name: 'Roma', sport: 'Soccer', league: 'Serie A', local: '/assets/logos/football/italian-serie-a/roma.png' },
          { name: 'Lazio', sport: 'Soccer', league: 'Serie A', local: '/assets/logos/football/italian-serie-a/lazio.png' },
          { name: 'Atalanta', sport: 'Soccer', league: 'Serie A', local: '/assets/logos/football/italian-serie-a/atalanta.png' },
          { name: 'Bayern Munich', sport: 'Soccer', league: 'Bundesliga', local: '/assets/logos/football/german-bundesliga/bayernmunich.png' },
          { name: 'Borussia Dortmund', sport: 'Soccer', league: 'Bundesliga', local: '/assets/logos/football/german-bundesliga/borussiadortmund.png' },
          { name: 'RB Leipzig', sport: 'Soccer', league: 'Bundesliga', local: '/assets/logos/football/german-bundesliga/rbleipzig.png' },
          { name: 'Bayer Leverkusen', sport: 'Soccer', league: 'Bundesliga', local: '/assets/logos/football/german-bundesliga/bayerleverkusen.png' },
          { name: 'Eintracht Frankfurt', sport: 'Soccer', league: 'Bundesliga', local: '/assets/logos/football/german-bundesliga/eintrachtfrankfurt.png' },
          { name: 'Marseille', sport: 'Soccer', league: 'Ligue 1', local: '/assets/logos/football/french-ligue-1/marseille.png' },
          { name: 'Lyon', sport: 'Soccer', league: 'Ligue 1', local: '/assets/logos/football/french-ligue-1/lyon.png' },
          { name: 'Lille', sport: 'Soccer', league: 'Ligue 1', local: '/assets/logos/football/french-ligue-1/lille.png' },
          { name: 'Nice', sport: 'Soccer', league: 'Ligue 1', local: '/assets/logos/football/french-ligue-1/nice.png' },
          { name: 'Ajax', sport: 'Soccer', league: 'Eredivisie', local: '/assets/logos/football/uefa-champions-league/ajax.png' },
          { name: 'Feyenoord', sport: 'Soccer', league: 'Eredivisie', local: '/assets/logos/football/uefa-champions-league/feyenoord.png' },
          { name: 'PSV Eindhoven', sport: 'Soccer', league: 'Eredivisie', local: '/assets/logos/football/uefa-champions-league/psveindhoven.png' },
          { name: 'FC Porto', sport: 'Soccer', league: 'Primeira Liga', local: '/assets/logos/football/uefa-champions-league/fcporto.png' },
          { name: 'Benfica', sport: 'Soccer', league: 'Primeira Liga', local: '/assets/logos/football/uefa-champions-league/benfica.png' },
          { name: 'Sporting CP', sport: 'Soccer', league: 'Primeira Liga', local: '/assets/logos/football/uefa-champions-league/sportingcp.png' },
          { name: 'Galatasaray', sport: 'Soccer', league: 'Super Lig', local: '/assets/logos/football/uefa-champions-league/galatasaray.png' },
          { name: 'Celtic', sport: 'Soccer', league: 'Scottish Premiership', local: '/assets/logos/football/uefa-champions-league/celtic.png' },
          { name: 'Club Brugge', sport: 'Soccer', league: 'Pro League', local: '/assets/logos/football/uefa-champions-league/clubbrugge.png' },
          { name: 'Dinamo Zagreb', sport: 'Soccer', league: 'Prva HNL', local: '/assets/logos/football/uefa-champions-league/dinamozagreb.png' },
          { name: 'Al Hilal', sport: 'Soccer', league: 'Saudi Pro League', local: '/assets/logos/football/saudi-pro-league/alhilal.png' },
          { name: 'Al Nassr', sport: 'Soccer', league: 'Saudi Pro League', local: '/assets/logos/football/saudi-pro-league/alnassr.png' },
          { name: 'Al Ittihad', sport: 'Soccer', league: 'Saudi Pro League', local: '/assets/logos/football/saudi-pro-league/alittihad.png' },
          { name: 'Al Ahly', sport: 'Soccer', league: 'Egyptian Premier League', local: '/assets/logos/football/egyptian-premier-league/alahly.png' },
          { name: 'Zamalek', sport: 'Soccer', league: 'Egyptian Premier League', local: '/assets/logos/football/egyptian-premier-league/zamalek.png' },
          { name: 'Flamengo', sport: 'Soccer', league: 'Brazilian Serie A', local: '/assets/logos/football/brazilian-serie-a/flamengo.png' },
          { name: 'Palmeiras', sport: 'Soccer', league: 'Brazilian Serie A', local: '/assets/logos/football/brazilian-serie-a/palmeiras.png' },
          { name: 'Corinthians', sport: 'Soccer', league: 'Brazilian Serie A', local: '/assets/logos/football/brazilian-serie-a/corinthians.png' },
          { name: 'Sao Paulo', sport: 'Soccer', league: 'Brazilian Serie A', local: '/assets/logos/football/brazilian-serie-a/saopaulo.png' },
          { name: 'Boca Juniors', sport: 'Soccer', league: 'Primera Division', local: '/assets/logos/football/argentina-primera-division/bocajuniors.png' },
          { name: 'River Plate', sport: 'Soccer', league: 'Primera Division', local: '/assets/logos/football/argentina-primera-division/riverplate.png' },
          { name: 'Atlanta Hawks', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/atlantahawks.png' },
          { name: 'Boston Celtics', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/bostonceltics.png' },
          { name: 'Brooklyn Nets', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/brooklynnets.png' },
          { name: 'Charlotte Hornets', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/charlottehornets.png' },
          { name: 'Chicago Bulls', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/chicagobulls.png' },
          { name: 'Cleveland Cavaliers', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/clevelandcavaliers.png' },
          { name: 'Dallas Mavericks', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/dallasmavericks.png' },
          { name: 'Denver Nuggets', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/denvernuggets.png' },
          { name: 'Detroit Pistons', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/detroitpistons.png' },
          { name: 'Golden State Warriors', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/goldenstatewarriors.png' },
          { name: 'Houston Rockets', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/houstonrockets.png' },
          { name: 'Indiana Pacers', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/indianapacers.png' },
          { name: 'Los Angeles Clippers', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/losangelesclippers.png' },
          { name: 'Los Angeles Lakers', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/losangeleslakers.png' },
          { name: 'Memphis Grizzlies', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/memphisgrizzlies.png' },
          { name: 'Miami Heat', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/miamiheat.png' },
          { name: 'Milwaukee Bucks', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/milwaukeebucks.png' },
          { name: 'Minnesota Timberwolves', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/minnesotatimberwolves.png' },
          { name: 'New Orleans Pelicans', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/neworleanspelicans.png' },
          { name: 'Oklahoma City Thunder', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/oklahomacitythunder.png' },
          { name: 'Orlando Magic', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/orlandomagic.png' },
          { name: 'Philadelphia 76ers', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/philadelphia76ers.png' },
          { name: 'Phoenix Suns', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/phoenixsuns.png' },
          { name: 'Portland Trail Blazers', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/portlandtrailblazers.png' },
          { name: 'Sacramento Kings', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/sacramentokings.png' },
          { name: 'Toronto Raptors', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/torontoraptors.png' },
          { name: 'Utah Jazz', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/utahjazz.png' },
          { name: 'Washington Wizards', sport: 'Basketball', league: 'NBA', local: '/assets/logos/nba/washingtonwizards.png' },
          { name: 'Arizona Cardinals', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/arizonacardinals.png' },
          { name: 'Atlanta Falcons', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/atlantafalcons.png' },
          { name: 'Baltimore Ravens', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/baltimoreravens.png' },
          { name: 'Buffalo Bills', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/buffalobills.png' },
          { name: 'Carolina Panthers', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/carolinapanthers.png' },
          { name: 'Chicago Bears', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/chicagobears.png' },
          { name: 'Cincinnati Bengals', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/cincinnatibengals.png' },
          { name: 'Cleveland Browns', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/clevelandbrowns.png' },
          { name: 'Dallas Cowboys', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/dallascowboys.png' },
          { name: 'Denver Broncos', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/denverbroncos.png' },
          { name: 'Detroit Lions', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/detroitlions.png' },
          { name: 'Green Bay Packers', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/greenbaypackers.png' },
          { name: 'Houston Texans', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/houstontexans.png' },
          { name: 'Indianapolis Colts', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/indianapoliscolts.png' },
          { name: 'Jacksonville Jaguars', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/jacksonvillejaguars.png' },
          { name: 'Kansas City Chiefs', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/kansascitychiefs.png' },
          { name: 'Las Vegas Raiders', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/lasvegasraiders.png' },
          { name: 'LA Chargers', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/losangeleschargers.png' },
          { name: 'LA Rams', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/losangelesrams.png' },
          { name: 'Miami Dolphins', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/miamidolphins.png' },
          { name: 'Minnesota Vikings', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/minnesotavikings.png' },
          { name: 'New England Patriots', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/newenglandpatriots.png' },
          { name: 'New Orleans Saints', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/neworleanssaints.png' },
          { name: 'New York Giants', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/newyorkgiants.png' },
          { name: 'New York Jets', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/newyorkjets.png' },
          { name: 'Philadelphia Eagles', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/philadelphiaeagles.png' },
          { name: 'Pittsburgh Steelers', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/pittsburghsteelers.png' },
          { name: 'San Francisco 49ers', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/sanfrancisco49ers.png' },
          { name: 'Seattle Seahawks', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/seattleseahawks.png' },
          { name: 'Tampa Bay Buccaneers', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/tampabaybuccaneers.png' },
          { name: 'Tennessee Titans', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/tennesseetitans.png' },
          { name: 'Washington Commanders', sport: 'Football', league: 'NFL', local: '/assets/logos/nfl/washingtoncommanders.png' },
          { name: 'Arizona Diamondbacks', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/arizonadiamondbacks.png' },
          { name: 'Atlanta Braves', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/atlantabraves.png' },
          { name: 'Baltimore Orioles', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/baltimoreorioles.png' },
          { name: 'Boston Red Sox', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/bostonredsox.png' },
          { name: 'Chicago Cubs', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/chicagocubs.png' },
          { name: 'Chicago White Sox', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/chicagowhitesox.png' },
          { name: 'Cincinnati Reds', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/cincinnatireds.png' },
          { name: 'Cleveland Guardians', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/clevelandguardians.png' },
          { name: 'Colorado Rockies', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/coloradorockies.png' },
          { name: 'Detroit Tigers', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/detroittigers.png' },
          { name: 'Houston Astros', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/houstonastros.png' },
          { name: 'Kansas City Royals', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/kansascityroyals.png' },
          { name: 'Los Angeles Angels', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/losangelesangels.png' },
          { name: 'Los Angeles Dodgers', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/losangelesdodgers.png' },
          { name: 'Miami Marlins', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/miamimarlins.png' },
          { name: 'Milwaukee Brewers', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/milwaukeebrewers.png' },
          { name: 'Minnesota Twins', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/minnesotatwins.png' },
          { name: 'New York Mets', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/newyorkmets.png' },
          { name: 'New York Yankees', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/newyorkyankees.png' },
          { name: 'Oakland Athletics', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/oaklandathletics.png' },
          { name: 'Philadelphia Phillies', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/philadelphiaphillies.png' },
          { name: 'Pittsburgh Pirates', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/pittsburghpirates.png' },
          { name: 'San Diego Padres', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/sandiegopadres.png' },
          { name: 'San Francisco Giants', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/sanfranciscogiants.png' },
          { name: 'Seattle Mariners', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/seattlemariners.png' },
          { name: 'St Louis Cardinals', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/stlouiscardinals.png' },
          { name: 'Tampa Bay Rays', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/tampabayrays.png' },
          { name: 'Texas Rangers', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/texasrangers.png' },
          { name: 'Toronto Blue Jays', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/torontobluejays.png' },
          { name: 'Washington Nationals', sport: 'Baseball', league: 'MLB', local: '/assets/logos/mlb/washingtonnationals.png' },
          { name: 'Anaheim Ducks', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/anaheimducks.png' },
          { name: 'Boston Bruins', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/bostonbruins.png' },
          { name: 'Buffalo Sabres', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/buffalosabres.png' },
          { name: 'Calgary Flames', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/calgaryflames.png' },
          { name: 'Carolina Hurricanes', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/carolinahurricanes.png' },
          { name: 'Chicago Blackhawks', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/chicagoblackhawks.png' },
          { name: 'Colorado Avalanche', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/coloradoavalanche.png' },
          { name: 'Columbus Blue Jackets', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/columbusbluejackets.png' },
          { name: 'Dallas Stars', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/dallasstars.png' },
          { name: 'Detroit Red Wings', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/detroitredwings.png' },
          { name: 'Edmonton Oilers', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/edmontonoilers.png' },
          { name: 'Florida Panthers', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/floridapanthers.png' },
          { name: 'Los Angeles Kings', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/losangeleskings.png' },
          { name: 'Minnesota Wild', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/minnesotawild.png' },
          { name: 'Montreal Canadiens', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/montrealcanadiens.png' },
          { name: 'Nashville Predators', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/nashvillepredators.png' },
          { name: 'New Jersey Devils', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/newjerseydevils.png' },
          { name: 'New York Islanders', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/newyorkislanders.png' },
          { name: 'New York Rangers', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/newyorkrangers.png' },
          { name: 'Ottawa Senators', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/ottawasenators.png' },
          { name: 'Philadelphia Flyers', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/philadelphiaflyers.png' },
          { name: 'Pittsburgh Penguins', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/pittsburghpenguins.png' },
          { name: 'San Jose Sharks', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/sanjosesharks.png' },
          { name: 'Seattle Kraken', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/seattlekraken.png' },
          { name: 'St Louis Blues', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/stlouisblues.png' },
          { name: 'Tampa Bay Lightning', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/tampabaylightning.png' },
          { name: 'Toronto Maple Leafs', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/torontomapleleafs.png' },
          { name: 'Utah Hockey Club', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/utahhockeyclub.png' },
          { name: 'Vancouver Canucks', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/vancouvercanucks.png' },
          { name: 'Vegas Golden Knights', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/vegasgoldenknights.png' },
          { name: 'Washington Capitals', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/washingtoncapitals.png' },
          { name: 'Winnipeg Jets', sport: 'Hockey', league: 'NHL', local: '/assets/logos/nhl/winnipegjets.png' },
          { name: 'Ferrari', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/ferrari.png' },
          { name: 'Red Bull Racing', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/redbullracing.png' },
          { name: 'Mercedes', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/mercedes.png' },
          { name: 'McLaren', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/mclaren.png' },
          { name: 'Aston Martin', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/astonmartin.png' },
          { name: 'Alpine', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/alpine.png' },
          { name: 'Williams', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/williams.png' },
          { name: 'Haas', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/haas.png' },
          { name: 'RB', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/rb.png' },
          { name: 'Kick Sauber', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/kicksauber.png' },
          { name: 'Audi', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/audirevolutf1team.png' },
          { name: 'Cadillac', sport: 'Motorsport', league: 'F1', local: '/assets/logos/f1/cadillacformula1team.png' }
        ];
        return teams;
      }
      ...
      async function loadSports(signal) {
        ...
        if (client) {
          try {
            const curatedNames = curated.map(t => t.name.replace(/^FC /, '').replace(/ FC$/, '').trim());
            const { data } = await client
              .from('teams')
            ...
            if (data) {
              for (const row of data) {
                const normalized = String(row.name || '').toLowerCase().replace(/[^a-z0-9]/g, '');
                if (row.logo_url) logoLookup[normalized] = row.logo_url;
              }
            }
            const nameAliases = {
            ...
            for (const [alias, canonical] of Object.entries(nameAliases)) {
              if (logoLookup[canonical] && !logoLookup[alias]) {
                logoLookup[alias] = logoLookup[canonical];
              }
            }
          } catch (_) {}
        }
