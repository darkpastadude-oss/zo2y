...
(function () {
  ...
  const MEDIA_LIST_ICONS = {
    ...
    restaurant:'fas fa-clapperboard', book:'fas fa-book',
    artist:'fas fa-microphone', music:'fas fa-music'
  };
