...
const APP_SHELL_CACHE = 'zo2y-app-shell-v239';
const PAGE_CACHE = 'zo2y-pages-v194';
...
const STATIC_ASSETS = [
  ...
  '/js/pages/index.js?v=20260425h',
  '/js/pages/index-home-heavy-loaders.js?v=20260425h',
