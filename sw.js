const APP_SHELL_CACHE = 'zo2y-app-shell-v189';
const PAGE_CACHE = 'zo2y-pages-v159';
...
const STATIC_ASSETS = [
  ...
  '/js/pages/index.js?v=20260325e',
  '/js/pages/index-home-heavy-loaders.js?v=20260325c',
