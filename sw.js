const APP_SHELL_CACHE = 'zo2y-app-shell-v188';
const PAGE_CACHE = 'zo2y-pages-v158';
...
const STATIC_ASSETS = [
  ...
  '/js/pages/index.js?v=20260325d',
  '/js/pages/index-home-heavy-loaders.js?v=20260325b',
