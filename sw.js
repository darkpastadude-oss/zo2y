const APP_SHELL_CACHE = 'zo2y-app-shell-v201';
const PAGE_CACHE = 'zo2y-pages-v172';
...
const STATIC_ASSETS = [
  ...
  '/js/mobile-webapp.js',
  '/js/mobile-webapp.js?v=20260329b',
  '/js/mobile-app.css',
