...
const APP_SHELL_CACHE = 'zo2y-app-shell-v233';
const PAGE_CACHE = 'zo2y-pages-v188';
...
const STATIC_ASSETS = [
  ...
  '/js/pages/sports.js?v=20260425b',
  '/fashion.html',
  '/food.html',
  '/cars.html',
  '/brand.html',
