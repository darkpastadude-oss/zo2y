const APP_SHELL_CACHE = 'zo2y-app-shell-v8';
const PAGE_CACHE = 'zo2y-pages-v8';
const IMAGE_CACHE = 'zo2y-images-v3';
const API_CACHE = 'zo2y-api-v2';
...
const STATIC_ASSETS = [
  ...
  '/js/mobile-webapp.js',
  '/js/mobile-webapp.js?v=20260227e',
  '/js/mobile-app.css',
