const APP_SHELL_CACHE = 'zo2y-app-shell-v104';
const PAGE_CACHE = 'zo2y-pages-v108';
...
const STATIC_ASSETS = [
  ...
  '/js/pages/brands.js?v=20260316h',
  '/js/pages/brand.js?v=20260316i',
  '/team.html',
