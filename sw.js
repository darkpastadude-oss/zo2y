...
const APP_SHELL_CACHE = 'zo2y-app-shell-v304';
const PAGE_CACHE = 'zo2y-pages-v239';
const IMAGE_CACHE = 'zo2y-images-v65';
const API_CACHE = 'zo2y-api-v47';
...
const STATIC_ASSETS = [
  ...
  '/css/pages/index.css?v=20260714a',
  '/css/list-modal.css?v=20260710b',
