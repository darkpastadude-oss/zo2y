...
const APP_SHELL_CACHE = 'zo2y-app-shell-v265';
const PAGE_CACHE = 'zo2y-pages-v215';
...
const STATIC_ASSETS = [
  ...
  '/js/pages/index.js?v=20260625b',
  '/js/pages/index-home-heavy-loaders.js?v=20260625b',
