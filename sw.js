...
const APP_SHELL_CACHE = 'zo2y-app-shell-v232';
const PAGE_CACHE = 'zo2y-pages-v187';
...
const STATIC_ASSETS = [
  ...
  '/js/pages/index.js?v=20260424a',
  '/js/pages/index-home-heavy-loaders.js?v=20260424b',
