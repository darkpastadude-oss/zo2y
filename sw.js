const APP_SHELL_CACHE = 'zo2y-app-shell-v100';
const PAGE_CACHE = 'zo2y-pages-v104';
...
const STATIC_ASSETS = [
  ...
  '/js/pages/brands.js?v=20260316d',
  '/js/pages/brand.js?v=20260316d',
  '/team.html',
