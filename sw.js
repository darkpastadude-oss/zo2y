...
const APP_SHELL_CACHE = 'zo2y-app-shell-v244';
const PAGE_CACHE = 'zo2y-pages-v199';
const IMAGE_CACHE = 'zo2y-images-v44';
const API_CACHE = 'zo2y-api-v24';
...
const STATIC_ASSETS = [
  ...
  '/js/review-interactions.js?v=20260601b',
  '/js/list-utils.js?v=20260601b',
  '/js/index-list-menu-adapter.js?v=20260601b',
  '/js/universal-search.js?v=20260601b',
  '/js/auth-gate.js?v=20260601b',
  ...
  '/cars.html',
  '/brand.html',
  '/css/pages/brands.css?v=20260601b',
