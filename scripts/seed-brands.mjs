...
const extraFashionBrands = [
  ...
  { name: 'Dockers', domain: 'dockers.com', category: 'Casual', country: 'USA', founded: '1986', description: 'Classic khaki and casualwear label.', tags: ['casual'] },
  { name: 'Lee', domain: 'lee.com', category: 'Denim', country: 'USA', founded: '1889', description: 'Denim and workwear brand.', tags: ['denim'] },
  { name: 'Wrangler', domain: 'wrangler.com', category: 'Denim', country: 'USA', founded: '1947', description: 'Western-inspired denim brand.', tags: ['denim'] },
  { name: 'G-Star Raw', domain: 'g-star.com', category: 'Denim', country: 'Netherlands', founded: '1989', description: 'Dutch denim and streetwear label.', tags: ['denim', 'streetwear'] },
  { name: 'PacSun', domain: 'pacsun.com', category: 'Streetwear', country: 'USA', founded: '1980', description: 'Youth fashion and streetwear retailer.', tags: ['streetwear'] },
  { name: 'Foot Locker', domain: 'footlocker.com', category: 'Retail', country: 'USA', founded: '1974', description: 'Sneaker and sportswear retailer.', tags: ['retail', 'sneakers'] },
  { name: 'New Era', domain: 'neweracap.com', category: 'Accessories', country: 'USA', founded: '1920', description: 'Cap and headwear brand.', tags: ['accessories'] },
  { name: 'Steve Madden', domain: 'stevemadden.com', category: 'Footwear', country: 'USA', founded: '1990', description: 'Fashion footwear brand.', tags: ['footwear'] },
  ...
  { name: 'Cole Haan', domain: 'colehaan.com', category: 'Footwear', country: 'USA', founded: '1928', description: 'American footwear and accessories brand.', tags: ['footwear'] },
  { name: 'Quiksilver', domain: 'quiksilver.com', category: 'Surfwear', country: 'Australia', founded: '1969', description: 'Surf and boardriding apparel brand.', tags: ['surfwear'] },
  { name: 'Billabong', domain: 'billabong.com', category: 'Surfwear', country: 'Australia', founded: '1973', description: 'Surf lifestyle apparel label.', tags: ['surfwear'] },
  { name: 'Roxy', domain: 'roxy.com', category: 'Surfwear', country: 'Australia', founded: '1990', description: 'Women-focused surfwear brand.', tags: ['surfwear'] },
  { name: 'Mizuno', domain: 'mizunousa.com', category: 'Sportswear', country: 'Japan', founded: '1906', description: 'Japanese performance sportswear label.', tags: ['sportswear'] },
  { name: 'Umbro', domain: 'umbro.com', category: 'Sportswear', country: 'UK', founded: '1924', description: 'Football-focused sportswear brand.', tags: ['sportswear'] },
  { name: 'Kappa', domain: 'kappa.com', category: 'Sportswear', country: 'Italy', founded: '1967', description: 'Italian sportswear label.', tags: ['sportswear'] },
  { name: 'Superga', domain: 'superga.com', category: 'Footwear', country: 'Italy', founded: '1911', description: 'Italian sneaker brand.', tags: ['footwear'] },
  { name: 'Tom Ford', domain: 'tomfordfashion.com', category: 'Luxury', country: 'USA', founded: '2005', description: 'Luxury fashion and accessories house.', tags: ['luxury'] },
  { name: 'Loewe', domain: 'loewe.com', category: 'Luxury', country: 'Spain', founded: '1846', description: 'Spanish luxury fashion house.', tags: ['luxury'] },
  { name: 'Reformation', domain: 'thereformation.com', category: 'Womenswear', country: 'USA', founded: '2009', description: 'Sustainability-focused womenswear label.', tags: ['womenswear', 'sustainability'] },
...
const extraFoodBrands = [
  ...
  { name: 'Auntie Anne\'s', domain: 'auntieannes.com', category: 'Bakery', country: 'USA', founded: '1988', description: 'Pretzel and snack chain.', tags: ['bakery'] },
  { name: 'The Cheesecake Factory', domain: 'thecheesecakefactory.com', category: 'Restaurants', country: 'USA', founded: '1978', description: 'Upscale casual dining chain.', tags: ['restaurants'] },
  { name: 'Red Robin', domain: 'redrobin.com', category: 'Restaurants', country: 'USA', founded: '1969', description: 'Burger-focused casual dining chain.', tags: ['restaurants'] },
  ...
  { name: 'Portillo\'s', domain: 'portillos.com', category: 'Fast Casual', country: 'USA', founded: '1963', description: 'Chicago-style fast casual chain.', tags: ['fast casual'] },
  { name: 'Moe\'s Southwest Grill', domain: 'moes.com', category: 'Fast Casual', country: 'USA', founded: '2000', description: 'Southwest fast casual chain.', tags: ['fast casual', 'mexican'] },
  { name: 'Torchy\'s Tacos', domain: 'torchystacos.com', category: 'Fast Casual', country: 'USA', founded: '2006', description: 'Creative taco chain.', tags: ['fast casual', 'mexican'] },
  { name: 'Potbelly', domain: 'potbelly.com', category: 'Fast Casual', country: 'USA', founded: '1977', description: 'Toasted sandwich chain.', tags: ['sandwiches', 'fast casual'] },
  { name: 'Schlotzsky\'s', domain: 'schlotzskys.com', category: 'Fast Casual', country: 'USA', founded: '1971', description: 'Sandwich and pizza chain.', tags: ['sandwiches', 'fast casual'] },
  { name: 'Crumbl', domain: 'crumblcookies.com', category: 'Dessert', country: 'USA', founded: '2017', description: 'Cookie bakery chain.', tags: ['dessert'] },
  { name: 'Insomnia Cookies', domain: 'insomniacookies.com', category: 'Dessert', country: 'USA', founded: '2003', description: 'Late-night cookie chain.', tags: ['dessert'] },
  { name: 'Jamba', domain: 'jamba.com', category: 'Drinks', country: 'USA', founded: '1990', description: 'Smoothie and juice chain.', tags: ['drinks'] },
  { name: 'Dutch Bros', domain: 'dutchbros.com', category: 'Coffee', country: 'USA', founded: '1992', description: 'Drive-thru coffee chain.', tags: ['coffee'] },
  { name: 'A&W Restaurants', domain: 'awrestaurants.com', category: 'Fast Food', country: 'USA', founded: '1919', description: 'Root beer and burger chain.', tags: ['fast food'] },
  { name: 'White Castle', domain: 'whitecastle.com', category: 'Fast Food', country: 'USA', founded: '1921', description: 'Slider burger chain.', tags: ['fast food'] },
  { name: 'Checkers & Rally\'s', domain: 'checkers.com', category: 'Fast Food', country: 'USA', founded: '1986', description: 'Drive-thru burger chain.', tags: ['fast food'] },
  { name: 'Bojangles Famous Chicken', domain: 'bojangles.com', category: 'Fast Food', country: 'USA', founded: '1977', description: 'Southern chicken and biscuits chain.', tags: ['fast food', 'chicken'] },
  { name: 'Culichi Town', domain: 'culichitown.com', category: 'Restaurants', country: 'USA', founded: '2011', description: 'Seafood and Mexican fusion restaurant group.', tags: ['restaurants'] },
  { name: 'Black Rifle Coffee Company', domain: 'blackriflecoffee.com', category: 'Coffee', country: 'USA', founded: '2014', description: 'Coffee chain and roaster.', tags: ['coffee'] },
  { name: 'Cafe Rio', domain: 'caferio.com', category: 'Fast Casual', country: 'USA', founded: '1997', description: 'Mexican grill fast casual chain.', tags: ['fast casual', 'mexican'] },
